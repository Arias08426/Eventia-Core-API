...
class ParticipantBase(BaseModel):
    ...
    email: EmailStr = Field(..., description="Email único del participante")
    phone: Optional[str] = Field(
        None, max_length=20, description="Teléfono del participante (opcional)"
    )
...
class ParticipantUpdate(BaseModel):
    ...
    email: Optional[EmailStr] = Field(None, description="Email único del participante")
    phone: Optional[str] = Field(
        None, max_length=20, description="Teléfono del participante"
    )
    ...
    class Config:
        ...
        json_schema_extra = {
            "example": {"name": "Juan Pérez García", "phone": "+573009876543"}
        }
