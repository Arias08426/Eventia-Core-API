...
from src.models import Attendance, Event, Participant
...
class TestDatabaseIntegration:
    ...
    def test_participant_email_unique_constraint(self, db):
        ...
        participant1 = Participant(
            name="Participant 1", email="test@example.com", phone="+573001234567"
        )
        db.add(participant1)
        db.commit()
    ...
    def test_relationship_participant_to_attendances(self, db, create_attendance):
        ...
        participant = (
            ...
            .filter(Participant.id == create_attendance.participant_id)
            .first()
        )
