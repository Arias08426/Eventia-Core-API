...
class TestAttendanceAPI:
    ...
    def test_register_attendance_success(self, client, create_event, create_participant):
    ...
    def test_register_attendance_capacity_exceeded(self, client, db, create_event, create_multiple_participants):
    ...
    def test_get_participant_attendances(self, client, create_attendance):
        ...
        # Act
        response = client.get(f"/attendances/participant/{create_attendance.participant_id}")
